...
public class Optics {
	...
	public static void main(String[] args) throws Exception {
		...
		Clusterer cl = new OPTICS();

		System.out.println("Méthode utilisée : OPTICS"); 
		...
		for (int i = 0; i < clusters.length; i++) { 
			FileHandler.exportDataset(clusters[i], new File("C:\\Users\\Clément\\Documents\\workspace\\M1_SC\\Projet_tut\\Output\\OPTICSoutput" + i + ".txt")); 
		} 
